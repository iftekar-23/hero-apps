...
import { addInstalled } from "../utilis/localStorage";
...
const AppCardDetails = () => {
    ...
    // Ratings data dynamically from JSON
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center">
                ...
                <div>
                    <div>
                        ...
                        <p className="text-gray-500 mb-4">Developed by <span className="text-blue-700">{app.companyName}</span></p>
                    </div>
                    ...
                    <button
                        ...
                        disabled={installed}
                        className={`px-6 py-3 rounded-lg font-semibold text-white transition ${installed
